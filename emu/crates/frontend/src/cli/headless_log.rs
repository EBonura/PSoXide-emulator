...
impl CounterLog {
    ...
    pub(super) fn record(
        ...
        writeln!(
            ...
            g(c::PLAYER_ANIM_ACTION),
            g(c::ROOM_PLAYER_LOCAL_Y_BIASED),
            g(c::ROOM_CAMERA_LOCAL_Y_BIASED),
            g(c::ROOM_CAMERA_VIEW_SIN_YAW_Q12_BIASED),
            g(c::ROOM_CAMERA_VIEW_COS_YAW_Q12_BIASED),
