...
//!
//! The central panel can present either the packed CPU-reference
//! display texture (native mode) or the hardware renderer's
//! VRAM-shaped target (high-resolution mode).
